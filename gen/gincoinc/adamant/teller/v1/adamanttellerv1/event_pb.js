...
goog.exportSymbol('proto.adamant.teller.v1.EthereumStakingReward', null, global);
goog.exportSymbol('proto.adamant.teller.v1.StakingRewardReceived', null, global);
goog.exportSymbol('proto.adamant.teller.v1.TransferUpdateCosmosSpecific', null, global);
goog.exportSymbol('proto.adamant.teller.v1.TransferUpdateEvent', null, global);
goog.exportSymbol('proto.adamant.teller.v1.TransferUpdateSubstrateSpecific', null, global);
 ...
 * @constructor
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.adamant.teller.v1.TransferUpdateCosmosSpecific, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.adamant.teller.v1.TransferUpdateCosmosSpecific.displayName = 'proto.adamant.teller.v1.TransferUpdateCosmosSpecific';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.adamant.teller.v1.TransferUpdateSubstrateSpecific = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.adamant.teller.v1.TransferUpdateSubstrateSpecific, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.displayName = 'proto.adamant.teller.v1.TransferUpdateSubstrateSpecific';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.adamant.teller.v1.EthereumStakingReward = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.adamant.teller.v1.EthereumStakingReward, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.adamant.teller.v1.EthereumStakingReward.displayName = 'proto.adamant.teller.v1.EthereumStakingReward';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.adamant.teller.v1.StakingRewardReceived = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.adamant.teller.v1.StakingRewardReceived, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.adamant.teller.v1.StakingRewardReceived.displayName = 'proto.adamant.teller.v1.StakingRewardReceived';
}
...
proto.adamant.teller.v1.TransferUpdated.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 20:
      ...
      break;
    case 22:
      var value = new proto.adamant.teller.v1.TransferUpdateCosmosSpecific;
      reader.readMessage(value,proto.adamant.teller.v1.TransferUpdateCosmosSpecific.deserializeBinaryFromReader);
...
proto.adamant.teller.v1.TransferUpdated.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      22,
      f,
      proto.adamant.teller.v1.TransferUpdateCosmosSpecific.serializeBinaryToWriter
    );
  }
...
/**
 * optional TransferUpdateCosmosSpecific cosmos_specific = 22;
 * @return {?proto.adamant.teller.v1.TransferUpdateCosmosSpecific}
 */
proto.adamant.teller.v1.TransferUpdated.prototype.getCosmosSpecific = function() {
  return /** @type{?proto.adamant.teller.v1.TransferUpdateCosmosSpecific} */ (
    jspb.Message.getWrapperField(this, proto.adamant.teller.v1.TransferUpdateCosmosSpecific, 22));
};


/**
 * @param {?proto.adamant.teller.v1.TransferUpdateCosmosSpecific|undefined} value
 * @return {!proto.adamant.teller.v1.TransferUpdated} returns this
*/
proto.adamant.teller.v1.TransferUpdated.prototype.setCosmosSpecific = function(value) {
 ...
 * @return {!proto.adamant.teller.v1.TransferUpdated} returns this
 */
proto.adamant.teller.v1.TransferUpdated.prototype.clearCosmosSpecific = function() {
 ...
 * @return {boolean}
 */
proto.adamant.teller.v1.TransferUpdated.prototype.hasCosmosSpecific = function() {
  return jspb.Message.getField(this, 22) != null;
};


/**
 * optional TransferUpdateSubstrateSpecific substrate_specific = 23;
 * @return {?proto.adamant.teller.v1.TransferUpdateSubstrateSpecific}
 */
proto.adamant.teller.v1.TransferUpdated.prototype.getSubstrateSpecific = function() {
  return /** @type{?proto.adamant.teller.v1.TransferUpdateSubstrateSpecific} */ (
    jspb.Message.getWrapperField(this, proto.adamant.teller.v1.TransferUpdateSubstrateSpecific, 23));
};


/**
 * @param {?proto.adamant.teller.v1.TransferUpdateSubstrateSpecific|undefined} value
 * @return {!proto.adamant.teller.v1.TransferUpdated} returns this
*/
proto.adamant.teller.v1.TransferUpdated.prototype.setSubstrateSpecific = function(value) {
 ...
 * @return {!proto.adamant.teller.v1.TransferUpdated} returns this
 */
proto.adamant.teller.v1.TransferUpdated.prototype.clearSubstrateSpecific = function() {
 ...
 * @return {!Object}
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific.prototype.toObject = function(opt_includeInstance) {
  return proto.adamant.teller.v1.TransferUpdateCosmosSpecific.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.adamant.teller.v1.TransferUpdateCosmosSpecific} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.adamant.teller.v1.TransferUpdateCosmosSpecific}
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.adamant.teller.v1.TransferUpdateCosmosSpecific;
  return proto.adamant.teller.v1.TransferUpdateCosmosSpecific.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.adamant.teller.v1.TransferUpdateCosmosSpecific} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.adamant.teller.v1.TransferUpdateCosmosSpecific}
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.adamant.teller.v1.TransferUpdateCosmosSpecific.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.adamant.teller.v1.TransferUpdateCosmosSpecific} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getType();
  if (f !== 0.0) {
    writer.writeEnum(
 ...
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific.prototype.getType = function() {
 ...
 * @return {!proto.adamant.teller.v1.TransferUpdateCosmosSpecific} returns this
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific.prototype.setType = function(value) {
 ...
 * @return {number}
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific.prototype.getDelegateAmount = function() {
 ...
 * @return {!proto.adamant.teller.v1.TransferUpdateCosmosSpecific} returns this
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific.prototype.setDelegateAmount = function(value) {
 ...
 * @return {number}
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific.prototype.getRewardAmount = function() {
 ...
 * @return {!proto.adamant.teller.v1.TransferUpdateCosmosSpecific} returns this
 */
proto.adamant.teller.v1.TransferUpdateCosmosSpecific.prototype.setRewardAmount = function(value) {
 ...
 * @return {!Object}
 */
proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.prototype.toObject = function(opt_includeInstance) {
  return proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.adamant.teller.v1.TransferUpdateSubstrateSpecific} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.toObject = function(includeInstance, msg) {
  var f, obj = {
    extrinsicId: jspb.Message.getFieldWithDefault(msg, 1, ""),
    extrinsicHash: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * @return {!proto.adamant.teller.v1.TransferUpdateSubstrateSpecific}
 */
proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.adamant.teller.v1.TransferUpdateSubstrateSpecific;
  return proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.adamant.teller.v1.TransferUpdateSubstrateSpecific} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.adamant.teller.v1.TransferUpdateSubstrateSpecific}
 */
proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.adamant.teller.v1.TransferUpdateSubstrateSpecific} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * optional string extrinsic_id = 1;
 * @return {string}
 */
proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.prototype.getExtrinsicId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.adamant.teller.v1.TransferUpdateSubstrateSpecific} returns this
 */
proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.prototype.setExtrinsicId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string extrinsic_hash = 2;
 * @return {string}
 */
proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.prototype.getExtrinsicHash = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.adamant.teller.v1.TransferUpdateSubstrateSpecific} returns this
 */
proto.adamant.teller.v1.TransferUpdateSubstrateSpecific.prototype.setExtrinsicHash = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
...
/**
 * optional TransferUpdateSubstrateSpecific substrate_specific = 16;
 * @return {?proto.adamant.teller.v1.TransferUpdateSubstrateSpecific}
 */
proto.adamant.teller.v1.TransferUpdateEvent.prototype.getSubstrateSpecific = function() {
  return /** @type{?proto.adamant.teller.v1.TransferUpdateSubstrateSpecific} */ (
    jspb.Message.getWrapperField(this, proto.adamant.teller.v1.TransferUpdateSubstrateSpecific, 16));
};
 ...
 * @return {!proto.adamant.teller.v1.TransferUpdateEvent} returns this
*/
proto.adamant.teller.v1.TransferUpdateEvent.prototype.setSubstrateSpecific = function(value) {
 ...
 * @return {!proto.adamant.teller.v1.TransferUpdateEvent} returns this
 */
proto.adamant.teller.v1.TransferUpdateEvent.prototype.clearSubstrateSpecific = function() {
  return this.setSubstrateSpecific(undefined);
};
 ...
 * @return {boolean}
 */
proto.adamant.teller.v1.TransferUpdateEvent.prototype.hasSubstrateSpecific = function() {
 ...
 * @return {!Object}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.toObject = function(opt_includeInstance) {
  return proto.adamant.teller.v1.EthereumStakingReward.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.adamant.teller.v1.EthereumStakingReward} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.adamant.teller.v1.EthereumStakingReward.toObject = function(includeInstance, msg) {
  var f, obj = {
    eventId: jspb.Message.getFieldWithDefault(msg, 1, ""),
    withdrawalIndex: jspb.Message.getFieldWithDefault(msg, 2, 0),
    ...
    validatorIndex: jspb.Message.getFieldWithDefault(msg, 5, 0),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.adamant.teller.v1.EthereumStakingReward}
 */
proto.adamant.teller.v1.EthereumStakingReward.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.adamant.teller.v1.EthereumStakingReward;
  return proto.adamant.teller.v1.EthereumStakingReward.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.adamant.teller.v1.EthereumStakingReward} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.adamant.teller.v1.EthereumStakingReward}
 */
proto.adamant.teller.v1.EthereumStakingReward.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 8:
      ...
      break;
    case 9:
      var value = /** @type {!proto.gincoinc.global.v1.EthereumStakingRewardLayerType} */ (reader.readEnum());
      msg.setEthereumStakingRewardLayerType(value);
      break;
    case 10:
      var value = /** @type {string} */ (reader.readString());
      msg.setStringValue(value);
 ...
 * @return {!Uint8Array}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.adamant.teller.v1.EthereumStakingReward.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.adamant.teller.v1.EthereumStakingReward} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.adamant.teller.v1.EthereumStakingReward.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEventId();
  if (f.length > 0) {
    writer.writeString(
  ...
  f = message.getEthereumStakingRewardLayerType();
  if (f !== 0.0) {
    writer.writeEnum(
      9,
      f
 ...
 * @return {string}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.getEventId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.setEventId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional uint64 withdrawal_index = 2;
 * @return {number}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.getWithdrawalIndex = function() {
 ...
 * @return {!proto.adamant.teller.v1.EthereumStakingReward} returns this
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.setWithdrawalIndex = function(value) {
 ...
 * @return {number}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.getBlockNumber = function() {
 ...
 * @return {!proto.adamant.teller.v1.EthereumStakingReward} returns this
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.setBlockNumber = function(value) {
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.getBlockTime = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
 ...
 * @return {!proto.adamant.teller.v1.EthereumStakingReward} returns this
*/
proto.adamant.teller.v1.EthereumStakingReward.prototype.setBlockTime = function(value) {
 ...
 * @return {!proto.adamant.teller.v1.EthereumStakingReward} returns this
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.clearBlockTime = function() {
 ...
 * @return {boolean}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.hasBlockTime = function() {
  return jspb.Message.getField(this, 4) != null;
};


/**
 * optional uint64 validator_index = 5;
 * @return {number}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.getValidatorIndex = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
 ...
 * @return {!proto.adamant.teller.v1.EthereumStakingReward} returns this
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.setValidatorIndex = function(value) {
  return jspb.Message.setProto3IntField(this, 5, value);
};
 ...
 * @return {string}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.getAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
};
 ...
 * @return {!proto.adamant.teller.v1.EthereumStakingReward} returns this
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.setAddress = function(value) {
  return jspb.Message.setProto3StringField(this, 6, value);
};
 ...
 * @return {number}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.getValue = function() {
 ...
 * @return {!proto.adamant.teller.v1.EthereumStakingReward} returns this
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.setValue = function(value) {
 ...
 * @return {string}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.getWalletId = function() {
 ...
 * @return {!proto.adamant.teller.v1.EthereumStakingReward} returns this
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.setWalletId = function(value) {
  return jspb.Message.setProto3StringField(this, 8, value);
};


/**
 * optional gincoinc.global.v1.EthereumStakingRewardLayerType ethereum_staking_reward_layer_type = 9;
 * @return {!proto.gincoinc.global.v1.EthereumStakingRewardLayerType}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.getEthereumStakingRewardLayerType = function() {
  return /** @type {!proto.gincoinc.global.v1.EthereumStakingRewardLayerType} */ (jspb.Message.getFieldWithDefault(this, 9, 0));
};


/**
 * @param {!proto.gincoinc.global.v1.EthereumStakingRewardLayerType} value
 * @return {!proto.adamant.teller.v1.EthereumStakingReward} returns this
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.setEthereumStakingRewardLayerType = function(value) {
  return jspb.Message.setProto3EnumField(this, 9, value);
};
 ...
 * @return {string}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.getStringValue = function() {
 ...
 * @return {string}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.getTxId = function() {
 ...
 * @return {!proto.adamant.teller.v1.EthereumStakingReward} returns this
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.setTxId = function(value) {
 ...
 * @return {!proto.adamant.teller.v1.EthereumStakingReward} returns this
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.clearTxId = function() {
 ...
 * @return {boolean}
 */
proto.adamant.teller.v1.EthereumStakingReward.prototype.hasTxId = function() {
  return jspb.Message.getField(this, 12) != null;
};
 ...
 * @return {!Object}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.toObject = function(opt_includeInstance) {
  return proto.adamant.teller.v1.StakingRewardReceived.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.adamant.teller.v1.StakingRewardReceived} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.adamant.teller.v1.StakingRewardReceived.toObject = function(includeInstance, msg) {
  var f, obj = {
    eventId: jspb.Message.getFieldWithDefault(msg, 1, ""),
    ...
    coin: jspb.Message.getFieldWithDefault(msg, 9, 0),
    time: (f = msg.getTime()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.adamant.teller.v1.StakingRewardReceived}
 */
proto.adamant.teller.v1.StakingRewardReceived.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.adamant.teller.v1.StakingRewardReceived;
  return proto.adamant.teller.v1.StakingRewardReceived.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.adamant.teller.v1.StakingRewardReceived} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.adamant.teller.v1.StakingRewardReceived}
 */
proto.adamant.teller.v1.StakingRewardReceived.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.adamant.teller.v1.StakingRewardReceived.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.adamant.teller.v1.StakingRewardReceived} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.adamant.teller.v1.StakingRewardReceived.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEventId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.getEventId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.adamant.teller.v1.StakingRewardReceived} returns this
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.setEventId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.getValidatorId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.adamant.teller.v1.StakingRewardReceived} returns this
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.setValidatorId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.getValue = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 3, 0.0));
};
 ...
 * @return {!proto.adamant.teller.v1.StakingRewardReceived} returns this
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.setValue = function(value) {
  return jspb.Message.setProto3FloatField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.getStringValue = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.adamant.teller.v1.StakingRewardReceived} returns this
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.setStringValue = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {string}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.getTxId = function() {
 ...
 * @return {!proto.adamant.teller.v1.StakingRewardReceived} returns this
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.setTxId = function(value) {
 ...
 * @return {number}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.getTxIndex = function() {
 ...
 * @return {!proto.adamant.teller.v1.StakingRewardReceived} returns this
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.setTxIndex = function(value) {
 ...
 * @return {string}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.getWalletId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 7, ""));
};
 ...
 * @return {!proto.adamant.teller.v1.StakingRewardReceived} returns this
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.setWalletId = function(value) {
  return jspb.Message.setProto3StringField(this, 7, value);
};
 ...
 * @return {string}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.getAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 8, ""));
};
 ...
 * @return {!proto.adamant.teller.v1.StakingRewardReceived} returns this
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.setAddress = function(value) {
  return jspb.Message.setProto3StringField(this, 8, value);
};


/**
 * optional gincoinc.global.v1.Coin coin = 9;
 * @return {!proto.gincoinc.global.v1.Coin}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.getCoin = function() {
  return /** @type {!proto.gincoinc.global.v1.Coin} */ (jspb.Message.getFieldWithDefault(this, 9, 0));
};
 ...
 * @return {!proto.adamant.teller.v1.StakingRewardReceived} returns this
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.setCoin = function(value) {
  return jspb.Message.setProto3EnumField(this, 9, value);
};
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.getTime = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
 ...
 * @return {!proto.adamant.teller.v1.StakingRewardReceived} returns this
*/
proto.adamant.teller.v1.StakingRewardReceived.prototype.setTime = function(value) {
 ...
 * @return {!proto.adamant.teller.v1.StakingRewardReceived} returns this
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.clearTime = function() {
  return this.setTime(undefined);
};
 ...
 * @return {boolean}
 */
proto.adamant.teller.v1.StakingRewardReceived.prototype.hasTime = function() {
